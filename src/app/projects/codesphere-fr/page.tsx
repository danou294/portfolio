...
export default function CodeSphereFrPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0B0B0E] overflow-x-hidden">
      ...
      {/* 1️⃣ Introduction — Présentation Produit */}
      <ProductHeroSection />

      {/* 2️⃣ Parcours Utilisateur — Expérience Produit */}
      <ProductUserJourneySection />

      {/* 3️⃣ Section Produit — Ce qui le rend unique */}
      <UniqueFeaturesSection />

      {/* 4️⃣ Section Produit avec Contexte Humain */}
      <HumanContextSection />

      {/* 5️⃣ Section Évolution — Fonctionnalités à venir */}
      <FutureFeaturesSection />

      {/* 6️⃣ Rejoindre l'aventure */}
      <JoinAdventureSection />

      {/* 7️⃣ Conclusion / CTA Final */}
      <FinalCTASection />
      ...
      <footer className="relative border-t border-gray-200 dark:border-white/5 py-12">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6">
          ...
          <div className="mt-8 text-center text-sm text-gray-600 dark:text-gray-600">
            Conçu et développé par <span className="text-blue-600 dark:text-[#5AB1FF]">Daniel Levy</span> — Fullstack Developer & Product Builder
          </div>
        </div>
      </footer>
    </div>
