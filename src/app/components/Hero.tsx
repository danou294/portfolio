        ...
        >
          ...
          >
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-lg">
              ...
              <span className="text-primary font-semibold">Node.js</span> et{" "}
          ...
          <div className="relative grid grid-cols-2 gap-6">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-lg font-semibold text-card-foreground text-center mb-2">Syg CRM</h3>
                <p className="text-center text-sm text-muted-foreground">Next.js • Node.js • MongoDB</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-center text-sm text-muted-foreground">Flutter • Firestore • Google Places</p>
              </div>
            </motion.div>
